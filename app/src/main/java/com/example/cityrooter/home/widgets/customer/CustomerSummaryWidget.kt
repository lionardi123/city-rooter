package com.example.cityrooter.home.widgets.customer
...
import com.example.cityrooter.databinding.CustomerSummaryWidgetBinding
...
class CustomerSummaryWidget(context: Context, attributeSet: AttributeSet): CoreFrameLayout(context, attributeSet) {
    ...
    private fun bindToView(){
        binding.customerTitleBanner.load(viewModel.titleBanner)
